...
var categoryText = ["Nødvendig", "Præferencer", "Statistik", "Markedsføring", "Uklassificeret"];

var learnMoreText = "Learn more about the provider";

var topSectionText = ["Samtykke", "Detaljer", "Om"];

var firstSectionText = "Vi bruger cookies til at tilpasse indhold og annoncer, levere funktioner på sociale medier og analysere vores trafik. Vi deler også oplysninger om din brug af vores hjemmeside med vores sociale medier, reklame- og analysepartnere, som kan kombinere dem med andre oplysninger, du har givet dem, eller som de har indsamlet fra din brug af deres tjenester.";

var thirdSectionText = "Cookies er små tekstfiler, der bruges af websteder til at forbedre brugeroplevelsen. Loven siger, at vi kan gemme cookies på din enhed, hvis de er strengt nødvendige for driften af ​​denne hjemmeside. For alle andre typer cookies har vi brug for din tilladelse. Det betyder, at cookies, der er klassificeret som nødvendige, administreres i henhold til artikel 6(1)(f) i GDPR. Alle andre cookies, såsom dem i kategorierne Præferencer og Marketing, administreres i henhold til artikel 6(1)(a) i GDPR. Denne hjemmeside bruger forskellige typer cookies. Nogle cookies sættes af tredjepartstjenester, der vises på vores sider.";

var bannerButtonsTexts = ["Acceptere", "Nedgang", "Tilpas", "Spare"];

var categoryDescriptionsText = {
	Necessary: {
		description: "Nødvendige cookies gør hjemmesiden brugbar ved at aktivere grundlæggende funktioner som sidenavigation og adgang til sikre områder på hjemmesiden. Uden disse cookies kan hjemmesiden ikke fungere korrekt.",
	},
	Preferences: {
		description: "Præferencecookies gør det muligt for et websted at huske oplysninger, der ændrer den måde, webstedet opfører sig eller ser ud på.",
	},
	Statistics: {
		description: "Statistikcookies hjælper webstedsejere med at forstå, hvordan besøgende interagerer med websteder ved at indsamle og rapportere oplysninger anonymt.",
	},
	Marketing: {
		description: "Marketingcookies bruges til at spore besøgende på tværs af websteder. Hensigten er at vise annoncer, der er relevante og engagerende for den enkelte bruger.",
	},
	Unclassified: {
		description: "Uklassificerede cookies er cookies, som vi i øjeblikket klassificerer sammen med udbyderne af individuelle cookies.",
	},
};
...
var websiteLogo = "https://missioneast.org/wp-content/uploads/2024/07/cropped-mission-east-logo_rgb-200x59.png";
